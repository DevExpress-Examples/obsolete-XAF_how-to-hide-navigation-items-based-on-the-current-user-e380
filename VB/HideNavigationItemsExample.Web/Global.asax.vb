...
#If EASYTEST Then
			...
			End If
#End If
            AddHandler DirectCast(WebApplication.Instance.Security, SecurityStrategy).CustomizeRequestProcessors, _
                Sub(sender2 As Object, e2 As CustomizeRequestProcessorsEventArgs)
                    ...
                    If security IsNot Nothing Then
                        Dim theUser As ISecurityUserWithRoles = TryCast(security.User, ISecurityUserWithRoles)
                        If theUser IsNot Nothing Then
                            For Each role As ISecurityRole In theUser.Roles
