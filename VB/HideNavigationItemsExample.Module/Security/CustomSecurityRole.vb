...
Namespace HideNavigationItemsExample.Module.Security
	<DefaultClassOptions, ImageName("BO_Role"), Appearance("HideHiddenNavigationItemsForAdministrators", AppearanceItemType:="LayoutItem", TargetItems := "HiddenNavigationItems", Visibility := ViewItemVisibility.Hide, Criteria := "IsAdministrative")>
