...
namespace HideNavigationItemsExample.Web {
    ...
    public partial class HideNavigationItemsExampleAspNetApplication : WebApplication {
        ...
        public HideNavigationItemsExampleAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void HideNavigationItemsExampleAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.HideNavigationItemsExampleAspNetApplication_DatabaseVersionMismatch);
